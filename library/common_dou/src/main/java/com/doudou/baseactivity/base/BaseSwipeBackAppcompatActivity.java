package com.doudou.baseactivity.base;
...
import com.doudou.baseactivity.R;
import com.doudou.baseactivity.app.AppManager;
...
//            localLayoutParams.flags = (WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS | localLayoutParams.flags);
    ...
    protected void showSelectDialog(String title, String msg, DialogInterface.OnClickListener posListioner){
        showDialog(title, msg, getApplicationContext().getResources().getString(R.string.ok)
                , getApplicationContext().getResources().getString(R.string.cancle)
                , posListioner, null);
    }
